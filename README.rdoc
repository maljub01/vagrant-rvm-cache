...
* {Andrew Vit's vagrant-apt_cache}[http://github.com/avit/vagrant-apt_cache] performs similar caching for APT. I highly recommend you check it out, especially if you're using Debian/Ubuntu guests and their variants.
